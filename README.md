...
- Initial code structure and implementation of the radix sort algorithm
- Debugging and fixing norminette compliance issues
- Code optimization and removal of unused functions
